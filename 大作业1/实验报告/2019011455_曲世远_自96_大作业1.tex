...
\begin{titlepage} %制作封面
    ...
    \vspace*{100pt}
    \begin{center}
        \fontsize{30pt}{0} 数\quad 值\quad 分\quad 析\quad 与\quad 算\quad 法\quad 础\quad \\
        \vspace*{36pt}
        \fontsize{36pt}{0}{大\quad 作\quad 业\quad 一}\\
        \vspace*{48pt}
        ...
        \heiti\Large 姓名\ \ \underline{\makebox[168pt]{\songti 曲世远}}\\
        \heiti\Large 学号\ \ \underline{\makebox[168pt]{\songti 2019011455}}\\
        \heiti\Large 院系\ \ \underline{\makebox[168pt]{\songti 自动化系}}\\
        %\heiti\Large 教师\ \ \underline{\makebox[168pt]{\songti Teacher}}\\
        \heiti\Large 时间\ \ \underline{\makebox[168pt]{\songti 2021.10.26}}\\
    \end{center}
\end{titlepage}
